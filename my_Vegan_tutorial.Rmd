...
```{r, include = FALSE}
# include = FALSE means it runs the library code but doesn't show it!
...
otu_table = otu_table[,! names(otus) %in% "Tax_Name"]
...
```{bash}
cd /Users/jamescutler/Desktop/Course_Materials/Data_Course/assignments/Assignment_6/fastasgood
ls *.fasta
echo "" # This gives a blank line
grep -c "^>" *.fasta
